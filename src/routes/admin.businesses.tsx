        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="relative">
            ...
            <input
              ...
              className="bg-neutral-900 border border-white/10 rounded-xl pl-9 pr-3 py-2 text-sm outline-none focus:border-[#df991b] w-72"
            />
          </div>
          <div className="relative">
            ...
            <select
              ...
              className="bg-neutral-900 border border-white/10 rounded-xl pl-8 pr-3 py-2 text-sm outline-none focus:border-[#df991b]"
            >
                      ...
                      <td className="p-4">
                        {isAdmin ? (
                          <select
                            ...
                            className="bg-neutral-900 border border-white/10 rounded-lg px-2 py-1 text-xs font-bold outline-none focus:border-[#df991b] disabled:opacity-50"
