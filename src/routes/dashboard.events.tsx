      ...
      <div className="flex items-center justify-between">
        ...
        {unlocked && (
          <button
            ...
            className="bg-[#1A5336] hover:bg-[#123F27] text-white font-bold rounded-xl px-4 py-2.5 text-sm flex items-center gap-2"
          >
            ...
            >
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm rounded-xl bg-[#1A5336] hover:bg-[#123F27] text-white font-bold disabled:opacity-60"
                >
