...
async function sendOwnerEmail(params: {
  ...
  const html = `
    <div style="font-family:system-ui,Arial,sans-serif;max-width:560px;margin:0 auto;padding:24px;color:#0F3D24">
      <h2 style="margin:0 0 12px;color:#1A5336">Novo lead para ${escapeHtml(businessName)}</h2>
