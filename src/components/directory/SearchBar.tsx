...
export function SearchBar({
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="md:col-span-2 bg-neutral-900 hover:bg-[#df991b] transition-colors text-[#df991b] hover:text-white font-bold rounded-xl sm:rounded-2xl px-4 py-3 text-sm"
      >
